...
public class PageFault {
    ...
    public static void replacePage(Vector mem, int virtPageNum, int replacePageNum, ControlPanel controlPanel) {
        ...
        int minUsageCounter = Integer.MAX_VALUE;
        ...
        for (Object o : mem) {
            ...
            if (page.usageCounter < minUsageCounter && page.physical != -1) {
                minUsageCounter = page.usageCounter;
                leastRecentlyUsed = page;
                leastRecentlyUsedPageIndex = count;
            }
            count++;
        }
//        System.out.println("Min usage counter: " + minUsageCounter);
//        System.out.println("Least recently used page: " + leastRecentlyUsedPageIndex);

        Page replacement = (Page) mem.elementAt(replacePageNum);
        controlPanel.removePhysicalPage(leastRecentlyUsedPageIndex);
        assert leastRecentlyUsed != null;
        replacement.physical = leastRecentlyUsed.physical;
        controlPanel.addPhysicalPage(replacement.physical, replacePageNum);
