...
public class ControlPanel extends Frame {
    ...
    Label usageCounterLabel = new Label("0", Label.LEFT);
    ...
    public void init(Kernel useKernel, String commands, String config) {
        ...
        usageCounterLabel.reshape(395, 240 + 25, 200, 15);
        add(usageCounterLabel);
        ...
        Label usageLabel = new Label("usageCounter: ", Label.LEFT);
    ...
    public void paintPage(Page page) {
        ...
        usageCounterLabel.setText(Integer.toString(page.usageCounter));
    }
