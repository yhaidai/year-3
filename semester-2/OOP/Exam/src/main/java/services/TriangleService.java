...
public class TriangleService {
    ...
    public List<Triangle> findClosestSquareTriangles(double square) throws SQLException, ClassNotFoundException {
        List<Triangle> triangles = dao.findAll();
    ...
    public List<Triangle> findTrianglesWithLessRadius(double radius) throws SQLException, ClassNotFoundException {
        List<Triangle> triangles = dao.findAll();
